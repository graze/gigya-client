...
class ErrorCode
{
    ...
    const ERROR_DATA_PENDING = 100001;
    ...
    const ERROR_OK_WITH_ERRORS = 200008;
    /** The accounts have been linked successfully. */
    const ERROR_ACCOUNTS_LINKED = 200009;
    /**
    ...
    const ERROR_OK_WITH_ERROR_LOGIN_IDENTIFIER_EXISTS = 200010;
    /**
    ...
    static private $errors = [
        self::ERROR_OK                                    => ['OK ', 'Success.'],
        self::ERROR_DATA_PENDING                          => [
            'Data pending',
            'Data is still being processed. Please query again for the response.'
        ],
        ...
        self::ERROR_OK_WITH_ERRORS                        => [
            'OK with errors',
            'For reports purposes, when OK is returned but there were acceptable errors in the process.'
        ],
        self::ERROR_ACCOUNTS_LINKED                       => [
            'Accounts linked',
            'The accounts have been linked successfully.'
        ],
        self::ERROR_OK_WITH_ERROR_LOGIN_IDENTIFIER_EXISTS => [
